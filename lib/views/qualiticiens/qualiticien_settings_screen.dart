...
class QualiticianSettings extends StatefulWidget {
  const QualiticianSettings({super.key});

  @override
  State<QualiticianSettings> createState() => _QualiticianSettingsState();
}

class _QualiticianSettingsState extends State<QualiticianSettings> {
